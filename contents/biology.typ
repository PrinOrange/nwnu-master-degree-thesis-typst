...
#let orderedList(content, itemTitle: str) = [
...
#paratext-page(title: "个人简历、在学期间发表的学术论文及研究成果", numbering: "1",enablePagebreak: false)[
  #orderedList(itemTitle: "1. 个人简历")[
    + 2002年05月15日出生于河南省郑州市。
    + XXXX年XX月——20XX年XX月，在XX大学XX学院（系）XX专业本科毕业并获得XX学学士学位。
    + 20XX年XX月——至今，在西北师范大学XX院（系）XX学科攻读XX学硕士学位。
  ]
  #orderedList(itemTitle: "2. 在学期间发表的学术论文")[
