...
#let axiom(content) = context [
  ...
  #text(weight: "bold")[公理#numbering(chapter-numbering-state.get(), chapter)\-#context [#elem-counter.display("1")]]：#content
]
...
#let definition(content) = context [
  ...
  #set text(font: ("Times New Roman", "KaiTi_GB2312"), size: zh(-4))
  #let chapter = get-current-chapter-num()
  #text(weight: "bold")[定义#numbering(chapter-numbering-state.get(), chapter)\-#context [#elem-counter.display("1")]]：#content
]
...
#let proposition(content) = context [
  ...
  #set text(font: ("Times New Roman", "KaiTi_GB2312"), size: zh(-4))
  #let chapter = get-current-chapter-num()
  #text(weight: "bold")[命题#numbering(chapter-numbering-state.get(), chapter)\-#context elem-counter.display("1")]：#content
]
...
#let lemma(content) = context [
  ...
  #set text(font: ("Times New Roman", "KaiTi_GB2312"), size: zh(-4))
  #let chapter = get-current-chapter-num()
  #text(weight: "bold")[引理#numbering(chapter-numbering-state.get(), chapter)\-#context elem-counter.display("1")]：#content
]
...
#let theorem(content) = context [
  ...
  #set text(font: ("Times New Roman", "KaiTi_GB2312"), size: zh(-4))
  #let chapter = get-current-chapter-num()
  #text(weight: "bold")[定理#numbering(chapter-numbering-state.get(), chapter)\-#context elem-counter.display("1")]：#content
]
...
#let corollary(content) = context [
  ...
  #set text(font: ("Times New Roman", "KaiTi_GB2312"), size: zh(-4))
  #let chapter = get-current-chapter-num()
  #text(weight: "bold")[推论#numbering(chapter-numbering-state.get(), chapter)\-#context elem-counter.display("1")]：#content
]
...
#let remark(content) = context [
  ...
  #set text(font: ("Times New Roman", "KaiTi_GB2312"), size: zh(-4))
  #let chapter = get-current-chapter-num()
  #text(weight: "bold")[注#numbering(chapter-numbering-state.get(), chapter)\-#context elem-counter.display("1")]：#content
]
...
#let example(content) = context [
  ...
  #set text(font: ("Times New Roman", "KaiTi_GB2312"), size: zh(-4))
  #let chapter = get-current-chapter-num()
  #text(weight: "bold")[例#numbering(chapter-numbering-state.get(), chapter)\-#context elem-counter.display("1")]：#content
]
